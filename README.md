...
<h5 align="center">
   <i>Building safe, interpretable AI systems — where engineering precision meets creative expression.</i>
</h5>
...
### 🔭 I’m currently:
- **Model Risk Engineer @ DTCC** — leading initiatives in **Generative AI governance**, model validation, and LLM safety.  
- **Software Systems R&D Engineer @ Collins Aerospace** — developing and testing **RF & embedded systems**, MBSE integration, and **C++ simulation tools** aligned with MIL-STD frameworks.  
- Founder of **UN/TITLD**, a creative identity collective exploring **motion, perception, and storytelling through tech**.  
- Research interests: **ML metaheuristics**, **simulation modeling**, and **embedded AI systems** for reliability-critical applications.  
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/LLM--Evaluation-purple?style=for-the-badge" />
  <img src="https://img.shields.io/badge/NLP--Transformers-informational?style=for-the-badge" />
</p>

### Systems Engineering & Modeling
<p align="center">
  <img src="https://img.shields.io/badge/Jama--Connect-Requirements-orange?style=for-the-badge" />
...
### 🧠 [LLM-RiskBench](https://github.com/Maleek23/LLM-RiskBench)
A benchmarking and validation framework for **evaluating LLM performance in financial and model-risk contexts**, featuring BLEU/ROUGE/SBERT scoring, risk tagging, and transparency dashboards.

### 🛰️ NetTest Automation Suite
Legacy **C++ network testing application** extended with Python automation to process event-driven CSV inputs and integrate test outcomes with Jama via REST APIs.

### 🎨 UN/TITLD Creative Collective
A visual research and creative identity platform exploring how **motion, systems, and narrative** intersect in the digital space.

---

## 📜 Certifications & Affiliations

- [CISA – Certified Information Systems Auditor](https://www.credly.com/badges/0ee8fad4-9207-4632-9639-c07e6d34e71b/public_url)  
- MATLAB / Simulink Certified  
- Member — **NSBE**, **ISACA**, **INCOSE**  
...
<h5 align="center">
<i>“Engineering is language. Art is translation.” — Malik</i>
</h5>
